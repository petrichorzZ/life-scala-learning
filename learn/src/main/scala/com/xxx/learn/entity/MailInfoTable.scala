...
final case class MailInfoEntity(id: Long, receiver: String, mailSubject: String, mailContent: String, filePath: Option[String] = None, created: Option[Long] = None, updated: Option[Long] = None)
...
class MailInfoDAO(val profile: JdbcProfile) {
  ...
  class MailInfo(tag: Tag) extends Table[MailInfoEntity](tag, "mail_info") {
    ...
    val updated: Rep[Option[Long]] = column[Option[Long]]("updated", O.Default(None))
